...
function App() {
  return (
    <BrowserRouter>
      <Routes>
        <Route path={AppRoute.Main} element={<MainScreen backgroundSrc={'img/bg-the-grand-budapest-hotel.jpg'}
        ...
        <Route path={AppRoute.MyList}
               element={<PrivateRoute authorizationStatus={AuthorizationStatus.Auth} children={<MyListScreen/>}/>}
        />
        <Route path={AppRoute.Movie}
               element={<MoviePageScreen backgroundSrc={'img/bg-the-grand-budapest-hotel.jpg'}
                                         backgroundAlt={'The Grand Budapest Hotel'}
                                         title={'The Grand Budapest Hotel'}
                                         posterSrc={'img/the-grand-budapest-hotel-poster.jpg'}
                                         posterAlt={'The Grand Budapest Hotel poster'}
        ...
        <Route path={AppRoute.Review}
               element={<AddReviewScreen backgroundSrc={'img/bg-the-grand-budapest-hotel.jpg'}
                                         backgroundAlt={'The Grand Budapest Hotel'}
                                         title={'The Grand Budapest Hotel'}
                                         posterSrc={'img/the-grand-budapest-hotel-poster.jpg'}
                                         posterAlt={'The Grand Budapest Hotel poster'}/>}/>
